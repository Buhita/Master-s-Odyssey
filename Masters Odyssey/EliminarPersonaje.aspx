...
<head runat="server">
      ...
      <title>Master's Odyssey - Eliminar Personaje</title>
</head>
<body class="indigo lighten-5">
      ...
      <div style="text-align:center">
        <%
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                string nom = d.NombrePersonaje(id);

                Session["ideli"] = id;

                Response.Write("<h5>¿Está seguro de querer eliminar el personaje "+nom+"?</h5>");
            }
        ...
        <br/>
        <form id="form2" method="post" action="EliminarPersonaje.aspx">
           <div class="container">
               <table>
                   <tr>
    ...
    <%
        ...
        {
            string mensaje = d.BorrarPersonaje(int.Parse(op));
