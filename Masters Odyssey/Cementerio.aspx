<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cementerio.aspx.cs" Inherits="Masters_Odyssey.Cementerio" %>
...
<head runat="server">
    ...
    <title> Master's Odyssey - Cementerio </title>
</head>
      ...
      <h2 style="text-align:center">Master's Odyssey</h2>
        ...
        <br>
            <form id="form1" runat="server">
                <table id="tabper" class="bordered">
                    <tr id="tr1">
                        <td id="td1">NOMBRE</td>
                        <td id="td1">REVIVIR</td>
                    </tr>
                    <tr id="tr1">
                        <%
                            ...
                            DAO d = new DAO();
                            listap = d.ListaPersonajes();
                            listac = d.ListaCampañas();
                            foreach (var itemc in listac)
                            {
                                if (itemc.Nom_usu.Equals(Session["nom_usu"]))
                                {
                                    foreach (var itemp in listap)
                                    {
                                        if (itemp.Id_cam.Equals(itemc.Id) && itemp.Id_cem == 0)
                                        {
                                            Response.Write("<tr><td id='td1'>" + itemp.Nombre + "</td>");
                                            Response.Write("<td id='td1'><a href='revivir.aspx?id=" + itemp.Id + "'>O</a></td></tr>");
                                        }
                                    }
                                }
                            }
