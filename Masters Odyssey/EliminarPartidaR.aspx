<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarPartidaR.aspx.cs" Inherits="Masters_Odyssey.EliminarPartidaR1" %>
...
<head runat="server">
      ...
      <title>Master's Odyssey - Eliminar Partida</title>
</head>
<body class="indigo lighten-5">
      ...
      <div style="text-align:center">
        <%
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                string nom = d.NombrePartida(id);

                Session["ideli"] = id;

                Response.Write("<h5>¿Está seguro de querer eliminar la partida "+nom+"?</h5>");
            }
        ...
        <br/>
        <form id="form2" method="post" action="EliminarPartidaR.aspx">
           <div class="container">
               <table>
                   <tr>
    ...
    <%
        ...
        {
            string mensaje = d.EliminarPartidas(int.Parse(op));
