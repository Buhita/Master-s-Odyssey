<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="revivir.aspx.cs" Inherits="Masters_Odyssey.revivir" %>
...
<body>
     ...
     <%
         ...
         else
         {
             ...
             string mensaje = d.Revivir(id);
             Response.Write("<script>alert('"+mensaje+"');</script>");
             
             Response.Write("<script>location.href='Cementerio.aspx';</script>");
         }
