<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarPartidaporR.aspx.cs" Inherits="Masters_Odyssey.EliminarPartidaporR1" %>
    ...
    %>
     <header style="text-align: right; margin-right: 10px">
      ...
      <div style="text-align:center">
        ...
        <br/>
        <form id="form2" method="post" action="EliminarPartidaporR.aspx">
           <div class="container">
               <table>
                   <tr>
