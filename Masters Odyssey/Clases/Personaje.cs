...
namespace Masters_Odyssey.Clases
{
    public class Personaje
    {
        ...
        public Personaje(int id, string nombre, string raza, string clase, string estado1, string estado2, string estado3, string estado4, string estado5, string estado6, string estado7, string estado8, string caracter, int id_cem, int id_cam)
        {
            this.Id = id;
            this.Nombre = nombre;
            this.Raza = raza;
        ...
        public int Id_cem { get => id_cem; set => id_cem = value; }
